      ...
      children: const [
        ...
        _Section(
          ...
          body:
              ...
              'In the mobile app, usage patterns are tracked via Google Firebase Analytics (US), which collects device identifiers, '
              'screens viewed, and in-app interactions. On our website, we use PostHog analytics (US) for the same purpose. '
              'The mobile app does not use PostHog.\n\n'
        ...
        _Section(
          ...
          body:
              ...
              '• PostHog (US) — product analytics (website only).\n'
